                                    ...
                                    <a
                                        ...
                                        className={
                                            ...
                                            `d-block width-p-100 height-p-100 d-flex align-items-center justify-content-center padding-20 cursor-pointer ${
                                                thumb_image
                                                    ? ''
                                                    : 'border-1-5 b-color-line-40 border-radius-10'
                                            }`.classNames()
                                        }
                                    >
                                        <div
			...
			>
...

				{
					...
					<>
						...
						>
							<i className={'ch-icon ch-icon-arrow-right'.classNames()} style={{top: '50%', transform: 'rotate(180deg)'}}></i>
						</div>
						<div 
						...
						>
							<i className={'ch-icon ch-icon-arrow-right'.classNames()} style={{top: '50%'}}></i>
						</div>
					</>
				}
			</div>
