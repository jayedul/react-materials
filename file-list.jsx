...
export function ListFile({ files, style = {}, onRemove }) {
	...
	return _files.map((file, index) => {
		...
		return <div
			key={file_id}
			className={'d-flex align-items-center column-gap-14 padding-vertical-10 padding-horizontal-20 margin-top-10 border-radius-10 border-1 b-color-text-40 bg-color-white'.classNames()}
